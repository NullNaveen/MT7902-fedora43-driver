...
/* MT7902 uses custom structs defined below - cannot simply typedef to mt792x */
...
int mt7902_mcu_set_sniffer(struct mt7902_dev *dev, struct ieee80211_vif *vif,
			   bool enable);
int mt7902_mcu_config_sniffer(struct mt7902_vif *vif,
...
int mt7902_mcu_set_roc(struct mt7902_phy *phy, struct mt7902_vif *vif,
		       struct ieee80211_channel *chan, int duration,
		       enum mt7902_roc_req type, u8 token_id);
int mt7902_mcu_abort_roc(struct mt7902_phy *phy, struct mt7902_vif *vif,
			 u8 token_id);
...
struct mt7902_sta {
	...
	/* Added for kernel 6.17 compatibility with mt792x_sta */
	struct mt792x_link_sta deflink;
...
/* MT7902 custom structs - enabled for porting to kernel 6.17 */
struct mt7902_phy {
	...
	/* Added for kernel 6.17 compatibility */
	u8 sta_work_count;
	u8 clc_chan_conf;
...
struct mt7902_dev {
	...
	/* More kernel 6.17 compatibility fields from mt792x_dev */
...
/* End of MT7902 custom structs */

/* Inline functions - must be after struct definitions */
