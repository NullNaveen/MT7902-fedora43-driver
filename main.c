...
void mt7902_roc_work(struct work_struct *work)
{
	...
	phy = (struct mt7902_phy *)container_of(work, struct mt792x_phy,
						roc_work);
...
static int mt7902_abort_roc(struct mt7902_phy *phy, struct mt7902_vif *vif)
{
...
static int mt7902_set_rts_threshold(struct ieee80211_hw *hw, int radio_idx, u32 val)
{
...
void mt7902_csa_work(struct work_struct *work)
{
	...
	mvif = (struct mt7902_vif *)container_of(work, struct mt792x_vif,
						csa_work);
	dev = mvif->phy->dev;
	vif = container_of((void *)mvif, struct ieee80211_vif, drv_priv);
