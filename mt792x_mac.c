...
static u8
mt792x_phy_get_nf(struct mt7902_phy *phy, int idx)
{
	return 0;
}
...
{
	struct mt7902_dev *dev = container_of(mphy->dev, struct mt792x_dev, mt76);
...
{
	struct mt7902_dev *dev = container_of(mdev, struct mt792x_dev, mt76);
...
void mt792x_pm_wake_work(struct work_struct *work)
{
	...
	dev = (struct mt7902_dev *)container_of(work, struct mt792x_dev,
						pm.wake_work);
	mphy = dev->phy.mt76;
