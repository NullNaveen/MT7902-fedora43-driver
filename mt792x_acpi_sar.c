...
static int
mt792x_acpi_read(struct mt7902_dev *dev, u8 *method, u8 **tbl, u32 *len)
{
...
static int
mt792x_asar_acpi_read_mtcl(struct mt7902_dev *dev, u8 **table, u8 *version)
{
	int len, ret;
...
static int
mt792x_asar_acpi_read_mtds(struct mt7902_dev *dev, u8 **table, u8 version)
{
...
static int
mt792x_asar_acpi_read_mtgs(struct mt7902_dev *dev, u8 **table, u8 version)
{
	int len, ret, sarlen, prelen, tblcnt;
...
/* MTFG : Flag Table */
static int
mt792x_asar_acpi_read_mtfg(struct mt7902_dev *dev, u8 **table)
{
	int len, ret;
...
static s8
mt792x_asar_get_geo_pwr(struct mt7902_phy *phy,
...
static s8
mt792x_asar_range_pwr(struct mt7902_phy *phy,
...
static u32
mt792x_acpi_parse_mtcl_tbl_v3(struct mt7902_phy *phy, char *alpha2)
{
...
static u32
mt792x_acpi_parse_mtcl_tbl(struct mt7902_phy *phy, char *alpha2)
{
	struct mt792x_acpi_sar *sar = phy->acpisar;
