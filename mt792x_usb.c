...
static void mt792xu_cleanup(struct mt7902_dev *dev)
{
...
static void mt792xu_dma_prefetch(struct mt7902_dev *dev)
{
...
static void mt792xu_wfdma_init(struct mt7902_dev *dev)
{
	int i;
...
static int mt792xu_dma_rx_evt_ep4(struct mt7902_dev *dev)
{
...
static void mt792xu_epctl_rst_opt(struct mt7902_dev *dev, bool reset)
{
	u32 val;
...
{
	struct mt7902_dev *dev = usb_get_intfdata(usb_intf);
